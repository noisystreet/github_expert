...
Fork 工作流解决了这个问题。贡献者复制一份仓库到自己的账户，在自己的仓库上修改，然后请求原仓库合并改动。

.. note::
   **开源贡献的成功故事**
   
   GitHub 上有很多通过开源贡献成长的故事：
   
   - **Brandon Keepers**：他通过为 GitHub 的开源项目贡献代码，最终被 GitHub 招聘。从开源贡献者到全职员工，展示了开源的价值。
   
   - **Sindre Sorhus**：他是 GitHub 上最活跃的开源贡献者之一，维护超过 1000 个 npm 包。他通过开源贡献建立了个人品牌，成为全职开源开发者。
   
   - **Ken Thompson**：Google 的工程师，通过为 Kubernetes 等开源项目贡献代码，成为云原生社区的知名人物。
   
   - **学生案例**：很多学生通过为开源项目贡献代码，获得了实习和工作机会。比如修复一个 Bug，展示编程能力，引起公司注意。
   
   开源贡献不仅是技术实践，也是职业发展的途径。即使一个小的 PR，也可能带来意想不到的机会。
